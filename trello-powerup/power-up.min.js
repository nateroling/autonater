(function e(t,n,r){function s(o,u){if(!n[o]){if(!t[o]){var a=typeof require=="function"&&require;if(!u&&a)return a(o,!0);if(i)return i(o,!0);var f=new Error("Cannot find module '"+o+"'");throw f.code="MODULE_NOT_FOUND",f}var l=n[o]={exports:{}};t[o][0].call(l.exports,function(e){var n=t[o][1][e];return s(n?n:e)},l,l.exports,e,t,n,r)}return n[o].exports}var i=typeof require=="function"&&require;for(var o=0;o<r.length;o++)s(r[o]);return s})({1:[function(require,module,exports){var warn=require("./util/warn"),Promise=require("bluebird"),temporary={},retained={},index=0;setInterval(function(){var e=Object.keys(temporary),t=Date.now(),a=0;e.forEach(function(e){var r=temporary[e];r.expires<t&&(a++,delete temporary[e])})},1e3),module.exports={callback:function(e,t,a){var r=t.callback,n=t.action,o=t.options;return Promise["try"](function(){switch(n){case"run":if(retained.hasOwnProperty(r)){var t=retained[r];return t.call(null,e,o)}throw warn("Attempted to run callback that does not exist or was not retained"),e.NotHandled("callback does not exist or was not retained");case"retain":if(temporary.hasOwnProperty(r))return retained[r]=temporary[r].fx,delete temporary[r],r;throw warn("Attempted to retain callback that does not exist"),e.NotHandled("callback can no longer be retained");case"release":if(retained.hasOwnProperty(r))return void delete retained[r];throw warn("Attempted to release callback that is not retained"),e.NotHandled("callback can no longer be released");default:throw warn("Attempted an unknown callback action"),e.NotHandled("unknown callback action")}}).then(a)},serialize:function(e){var t="cb"+index++;return temporary[t]={fx:e,expires:Date.now()+1e4},{_callback:t}}}},{"./util/warn":17,bluebird:18}],2:[function(require,module,exports){!function(){this.TrelloPowerUp=require("./index")}()},{"./index":8}],3:[function(require,module,exports){!function(e){e.matches=e.matches||e.mozMatchesSelector||e.msMatchesSelector||e.oMatchesSelector||e.webkitMatchesSelector,e.closest=e.closest||function(e){for(var t=this;t&&!t.matches(e);)t=t.parentElement;return t}}(Element.prototype)},{}],4:[function(require,module,exports){var arg=require("./util/arg"),i18nError=require("./i18n-error"),processResult=require("./process-result"),relativeUrl=require("./util/relative-url"),PostMessageIO=require("post-message-io"),Promise=require("bluebird"),safe=require("./util/safe"),warn=require("./util/warn"),xtend=require("xtend"),HostHandlers={};HostHandlers.requestWithContext=function(e,t){return t=t||{},t.context=this.args[0].context,this.request(e,processResult(t))},HostHandlers.getAll=function(){return this.requestWithContext("data").then(function(e){var t={};return Object.keys(e).forEach(function(r){t[r]={},Object.keys(e[r]).forEach(function(n){try{t[r][n]=JSON.parse(e[r][n])}catch(s){t[r][n]={}}})}),t})},HostHandlers.get=function(e,t,r,n){return this.getAll(e,t).then(function(s){return s&&s.hasOwnProperty(e)&&s[e].hasOwnProperty(t)&&s[e][t].hasOwnProperty(r)?s[e][t][r]:n})},HostHandlers.set=function(e,t,r,n){var s=this;return this.getAll().get(e).then(function(e){return e||{}}).get(t).then(function(o){if(o=o||{},"object"==typeof r){var i=r;Object.keys(i).forEach(function(e){o[e]=i[e]})}else o[r]=n;return s.requestWithContext("set",{scope:e,visibility:t,data:JSON.stringify(o)})})},HostHandlers.safe=safe,HostHandlers.arg=function(e,t){var r=this.args[1];return r&&"object"==typeof r&&r.hasOwnProperty(e)?r[e]:t},HostHandlers.signUrl=function(e,t){var r=this.args[0].context;return[e,encodeURIComponent(JSON.stringify({secret:this.secret,context:r,locale:window.locale,args:t}))].join("#")},HostHandlers.popup=function(e){var t={title:e.title,callback:e.callback};if(e.url)t.content={type:"iframe",url:this.signUrl(relativeUrl(e.url),e.args),width:e.width,height:e.height};else if(e.items){var r;r=Array.isArray(e.items)||"function"==typeof e.items?e.items:Object.keys(e.items).map(function(t){var r=e.items[t];return"function"==typeof r&&(r={callback:r}),xtend({text:t},r)}),t.content={type:"list",items:r,search:e.search}}return this.requestWithContext("popup",t)},HostHandlers.overlay=function(e){var t={};return e.url&&(t.content={type:"iframe",url:this.signUrl(relativeUrl(e.url),e.args)}),this.requestWithContext("overlay",t)},HostHandlers.boardBar=function(e){var t={};return e.url&&(t.content={type:"iframe",url:this.signUrl(relativeUrl(e.url),e.args),height:e.height}),this.requestWithContext("board-bar",t)},HostHandlers.hide=function(e){return warn("hide() handler has been deprecated. Please use closePopup()"),this.requestWithContext("close-popup")},HostHandlers.closePopup=function(e){return this.requestWithContext("close-popup")},HostHandlers.back=function(e){return this.requestWithContext("pop-popup")},HostHandlers.hideOverlay=function(e){return warn("hideOverlay() handler has been deprecated. Please use closeOverlay()"),this.requestWithContext("close-overlay")},HostHandlers.closeOverlay=function(e){return this.requestWithContext("close-overlay")},HostHandlers.hideBoardBar=function(e){return warn("hideBoardBar() handler has been deprecated. Please use closeBoardBar()"),this.requestWithContext("close-board-bar")},HostHandlers.closeBoardBar=function(e){return this.requestWithContext("close-board-bar")},HostHandlers.sizeTo=function(e){var t=document.querySelector(e);return t?(t.style.overflow="hidden",this.requestWithContext("resize",{height:Math.ceil(Math.max(t.scrollHeight,t.getBoundingClientRect().height))})):Promise.reject(new Error("no elements matched"))},HostHandlers.localizeKey=function(e,t){if(window.localizer&&"function"==typeof window.localizer.localize)return window.localizer.localize(e,t);throw new i18nError.LocalizerNotFound("No localizer available for localization.")},HostHandlers.localizeKeys=function(e){if(!e)return[];var t=this;return e.map(function(e){if("string"==typeof e)return t.localizeKey(e);if(Array.isArray(e))return t.localizeKey(e[0],e[1]);throw new i18nError.UnsupportedKeyType("localizeKeys doesn't recognize the supplied key type: "+typeof e)})},HostHandlers.localizeNode=function(e){for(var t=e.querySelectorAll("[data-i18n-id],[data-i18n-attrs]"),r=0,n=t.length;n>r;r++){var s={},o=t[r];if(o.dataset.i18nArgs)try{s=JSON.parse(o.dataset.i18nArgs)}catch(i){throw new i18nError.UnableToParseArgs("Error parsing args. Error: "+i.message)}if(o.dataset.i18nId&&(o.textContent=this.localizeKey(o.dataset.i18nId,s)),o.dataset.i18nAttrs){var a;try{a=JSON.parse(o.dataset.i18nAttrs)}catch(i){throw new i18nError.UnableToParseAttrs("Error parsing attrs. Error: "+i.message)}a&&a.placeholder&&(o.placeholder=this.localizeKey(a.placeholder,s))}}},HostHandlers.card=function(){return this.requestWithContext("card",{fields:arguments})},HostHandlers.cards=function(){return this.requestWithContext("cards",{fields:arguments})},HostHandlers.list=function(){return this.requestWithContext("list",{fields:arguments})},HostHandlers.lists=function(){return this.requestWithContext("lists",{fields:arguments})},HostHandlers.member=function(){return this.requestWithContext("member",{fields:arguments})},HostHandlers.board=function(){return this.requestWithContext("board",{fields:arguments})},HostHandlers.attach=function(e){return this.requestWithContext("attach-to-card",e)},HostHandlers.requestToken=function(e){return this.requestWithContext("request-token",e)},HostHandlers.authorize=function(e,t){t=t||{};var r=PostMessageIO.randomId(),n=e(r),s=t.width||800,o=t.height||600,i=window.screenX+Math.floor((window.outerWidth-s)/2),a=window.screenY+Math.floor((window.outerHeight-o)/2);return new Promise(function(e){new PostMessageIO({local:window,remote:window.open(n,"authorize",["width=",s,",height=",o,",left=",i,",top=",a].join("")),targetOrigin:t.targetOrigin||"*",secret:r,handlers:{value:function(t,r){r&&r.token&&(this.stop(),e(r.token))}}})})},HostHandlers.notifyParent=function(e,t){t=t||{},window.parent.postMessage(e,t.targetOrigin||"*")},module.exports=HostHandlers},{"./i18n-error":5,"./process-result":12,"./util/arg":13,"./util/relative-url":15,"./util/safe":16,"./util/warn":17,bluebird:18,"post-message-io":20,xtend:22}],5:[function(require,module,exports){var makeErrorEnum=require("./util/make-error-enum");module.exports=makeErrorEnum("i18n",["ArgNotFound","InvalidResourceUrl","KeyNotFound","LoadLocalizerNotAFunction","LocaleNotFound","LocaleNotSpecified","LocalizerNotFound","MissingDefaultLocale","MissingResourceUrl","MissingSupportedLocales","UnableToParseArgs","UnableToParseAttrs","Unknown","UnsupportedKeyType"])},{"./util/make-error-enum":14}],6:[function(require,module,exports){var i18nError=require("./i18n-error"),Promise=require("bluebird"),loadOnce,localizer,activeLocale="",urlForLocale=function(e,r){if(e.indexOf("{locale}")<0)throw new i18nError.InvalidResourceUrl("ResourceUrl must specify where to place locale with {locale}");return e.replace("{locale}",r)},closestSupportedLocale=function(e,r,o){return o.indexOf(e)>-1?e:e.indexOf("-")>-1?closestSupportedLocale(e.split("-")[0],r,o):r},localize=function(e,r){var o=this;if(o.resourceDictionary[e]){var n=o.resourceDictionary[e];if(r){for(var l,i="",t=/\{(\w+?)\}/gi,a=0;l=t.exec(n);){if(l.index>a&&(i+=n.substring(a,l.index)),!r[l[1]])throw new i18nError.ArgNotFound("Arg: "+l[1]);i+=r[l[1]],a=l.index+l[0].length}return i+=n.substring(a)}return n}throw new i18nError.KeyNotFound("Key: "+e)},loadLocalizer=function(e,r,o,n){return Promise["try"](function(){var l;return l=e?closestSupportedLocale(e,r,o):r,l===activeLocale&&localizer?localizer:(loadOnce||(loadOnce=new Promise(function(e,r){var o=new XMLHttpRequest;o.open("GET",urlForLocale(n,l),!0),o.onload=function(){try{if(200===o.status){var n=JSON.parse(o.responseText);return localizer={resourceDictionary:n,localize:localize},activeLocale=l,e(localizer)}return r(404===o.status?new i18nError.LocaleNotFound(l+" not found."):new i18nError.Unknown("Unable to load locale, status: "+o.status))}catch(i){return r(new i18nError.Unknown(i.message))}},o.send()})),loadOnce)})};module.exports={loadLocalizer:loadLocalizer}},{"./i18n-error":5,bluebird:18}],7:[function(require,module,exports){var arg=require("./util/arg"),CallbackCache=require("./callback-cache"),HostHandlers=require("./host-handlers"),initi18n=require("./initialize-i18n"),initIO=require("./initialize-io"),PostMessageIO=require("post-message-io"),xtend=require("xtend"),TrelloIFrame=function(e){this.io=null,this.args=[{context:arg("context"),secret:arg("secret")}].concat(arg("args")),this.secret=arg("secret"),window.locale=arg("locale"),this.options=e};TrelloIFrame.prototype.connect=function(){var e={callback:CallbackCache.callback};this.io=initIO(e,xtend(this.options,{secret:arg("secret"),hostHandlers:HostHandlers}))},TrelloIFrame.prototype.request=function(e,t){return this.io.request(e,t)},TrelloIFrame.prototype.render=function(e){var t=this;window.addEventListener("message",function(r){r.source===window.parent&&"render"==r.data&&initi18n(window.locale,t.options).then(function(){e()})},!1)},TrelloIFrame.prototype.NotHandled=PostMessageIO.NotHandled;var method;for(method in HostHandlers)HostHandlers.hasOwnProperty(method)&&(TrelloIFrame.prototype[method]=HostHandlers[method]);module.exports=TrelloIFrame},{"./callback-cache":1,"./host-handlers":4,"./initialize-i18n":9,"./initialize-io":10,"./util/arg":13,"post-message-io":20,xtend:22}],8:[function(require,module,exports){var initi18n=require("./initialize-i18n"),makeErrorEnum=require("./util/make-error-enum"),PostMessageIO=require("post-message-io"),Promise=require("bluebird"),relativeUrl=require("./util/relative-url"),TrelloPlugin=require("./plugin"),TrelloIFrame=require("./iframe");require("./compatibility/closest"),module.exports={initialize:function(e,r){var i=new TrelloPlugin(e,r);i.connect()},iframe:function(e){var r=new TrelloIFrame(e);return r.connect(),r},PostMessageIO:PostMessageIO,Promise:Promise,util:{initLocalizer:initi18n,makeErrorEnum:makeErrorEnum,relativeUrl:relativeUrl}}},{"./compatibility/closest":3,"./iframe":7,"./initialize-i18n":9,"./plugin":11,"./util/make-error-enum":14,"./util/relative-url":15,bluebird:18,"post-message-io":20}],9:[function(require,module,exports){var i18n=require("./i18n"),i18nError=require("./i18n-error"),Promise=require("bluebird");module.exports=function(e,r){if(r=r||{},!e)return Promise.reject(new i18nError.LocaleNotSpecified("Unable to load a localizer without a locale"));if(window.localizer)return Promise.resolve();if(r.localizer)window.localizer=r.localizer;else{if(r.loadLocalizer)return"function"==typeof r.loadLocalizer?Promise.resolve(r.loadLocalizer(e)).then(function(e){return window.localizer=e,Promise.resolve()}):Promise.reject(new i18nError.LoadLocalizerNotAFunction("Specified loadLocalizer must be a function that returns a localizer or a Promise resolving to a localizer"));if(r.localization){var o=r.localization;return o.defaultLocale?o.supportedLocales?o.resourceUrl?i18n.loadLocalizer(e,o.defaultLocale,o.supportedLocales,o.resourceUrl).then(function(e){return window.localizer=e,Promise.resolve()}):Promise.reject(new i18nError.MissingResourceUrl("Missing resourceUrl")):Promise.reject(new i18nError.MissingSupportedLocales("Missing supportedLocales")):Promise.reject(new i18nError.MissingDefaultLocale("Missing defaultLocale"))}}return Promise.resolve()}},{"./i18n":6,"./i18n-error":5,bluebird:18}],10:[function(require,module,exports){var PostMessageIO=require("post-message-io");module.exports=function(e,r){r=r||{};var t=new PostMessageIO({local:window,remote:window.parent,targetOrigin:r.targetOrigin||"https://trello.com",secret:r.secret,handlers:e,hostHandlers:r.hostHandlers});return t}},{"post-message-io":20}],11:[function(require,module,exports){var arg=require("./util/arg"),CallbackCache=require("./callback-cache"),HostHandlers=require("./host-handlers"),initi18n=require("./initialize-i18n"),initIO=require("./initialize-io"),processResult=require("./process-result"),PostMessageIO=require("post-message-io"),Promise=require("bluebird"),xtend=require("xtend"),TrelloPlugin=function(e,t){self=this,this.io=null,this.handlers={},Object.keys(e).forEach(function(r){self.handlers[r]=function(){var i=arguments,n=this;return window.locale=i[1].locale,initi18n(window.locale,t).then(function(){return Promise["try"](function(){return e[r].apply(n,i)}).then(processResult)})}}),this.handlers.callback=function(e,t){return CallbackCache.callback.call(this,e,t,processResult)},this.options=t||{}};TrelloPlugin.prototype.connect=function(){var e=this.io=initIO(this.handlers,xtend(this.options,{secret:arg("secret"),hostHandlers:HostHandlers}));return e.request("initialize",Object.keys(this.handlers)).then(function(t){return e.secret=t.secret,e.request("ready")}).then(function(){return e})},TrelloPlugin.prototype.NotHandled=PostMessageIO.NotHandled,module.exports=TrelloPlugin},{"./callback-cache":1,"./host-handlers":4,"./initialize-i18n":9,"./initialize-io":10,"./process-result":12,"./util/arg":13,bluebird:18,"post-message-io":20,xtend:22}],12:[function(require,module,exports){var CallbackCache=require("./callback-cache"),relativeUrl=function(r){var e=location.origin||location.protocol+"//"+location.host;return[e,location.pathname.replace(/[^\/]+$/,""),r].join("")},process=function(r,e){if(!r)return r;if(("url"==e||"icon"==e)&&"string"==typeof r&&0==r.indexOf("./"))return relativeUrl(r.substr(2));switch(typeof r){case"object":if(Array.isArray(r))return r.map(process);var a={};return Object.keys(r).forEach(function(e){a[e]=process(r[e],e)}),a;case"function":return CallbackCache.serialize(r);default:return r}};module.exports=process},{"./callback-cache":1}],13:[function(require,module,exports){var hashData=null;module.exports=function(a,h){if(!hashData)try{hashData=JSON.parse(decodeURIComponent(location.hash.replace(/^#/,"")))}catch(t){hashData={}}return hashData.hasOwnProperty(a)?hashData[a]:h}},{}],14:[function(require,module,exports){var CustomError=require("error-ext"),reservedBaseName="Error";module.exports=function(r,e){var o=new CustomError([r,reservedBaseName].join("::"));return e.forEach(function(e){o[e]=new CustomError([r,e].join("::"),{},o)}),o}},{"error-ext":19}],15:[function(require,module,exports){module.exports=function(o){return/^https?:\/\//.test(o)?o:[location.protocol,"//",location.host,location.pathname.replace(/[^\/]+$/,""),o].join("")}},{}],16:[function(require,module,exports){module.exports=function(e){return String(null===e?"":e).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}},{}],17:[function(require,module,exports){module.exports=function(o){window.console&&"function"==typeof console.warn&&console.warn(o)}},{}],18:[function(require,module,exports){(function(process,global){!function(t){if("object"==typeof exports&&"undefined"!=typeof module)module.exports=t();else if("function"==typeof define&&define.amd)define([],t);else{var e;"undefined"!=typeof window?e=window:"undefined"!=typeof global?e=global:"undefined"!=typeof self&&(e=self),e.Promise=t()}}(function(){var t,e,r;return function n(t,e,r){function i(s,a){if(!e[s]){if(!t[s]){var u="function"==typeof _dereq_&&_dereq_;if(!a&&u)return u(s,!0);if(o)return o(s,!0);var c=new Error("Cannot find module '"+s+"'");throw c.code="MODULE_NOT_FOUND",c}var l=e[s]={exports:{}};t[s][0].call(l.exports,function(e){var r=t[s][1][e];return i(r?r:e)},l,l.exports,n,t,e,r)}return e[s].exports}for(var o="function"==typeof _dereq_&&_dereq_,s=0;s<r.length;s++)i(r[s]);return i}({1:[function(t,e,r){"use strict";e.exports=function(t){function e(t){var e=new r(t),n=e.promise();return e.setHowMany(1),e.setUnwrap(),e.init(),n}var r=t._SomePromiseArray;t.any=function(t){return e(t)},t.prototype.any=function(){return e(this)}}},{}],2:[function(t,e,r){"use strict";function n(){this._isTickUsed=!1,this._lateQueue=new l(16),this._normalQueue=new l(16),this._trampolineEnabled=!0;var t=this;this.drainQueues=function(){t._drainQueues()},this._schedule=c.isStatic?c(this.drainQueues):c}function i(t,e,r){this._lateQueue.push(t,e,r),this._queueTick()}function o(t,e,r){this._normalQueue.push(t,e,r),this._queueTick()}function s(t){this._normalQueue._pushOne(t),this._queueTick()}var a;try{throw new Error}catch(u){a=u}var c=t("./schedule.js"),l=t("./queue.js"),h=t("./util.js");n.prototype.disableTrampolineIfNecessary=function(){h.hasDevTools&&(this._trampolineEnabled=!1)},n.prototype.enableTrampoline=function(){this._trampolineEnabled||(this._trampolineEnabled=!0,this._schedule=function(t){setTimeout(t,0)})},n.prototype.haveItemsQueued=function(){return this._normalQueue.length()>0},n.prototype.throwLater=function(t,e){if(1===arguments.length&&(e=t,t=function(){throw e}),"undefined"!=typeof setTimeout)setTimeout(function(){t(e)},0);else try{this._schedule(function(){t(e)})}catch(r){throw new Error("No async scheduler available\n\n    See http://goo.gl/m3OTXk\n")}},h.hasDevTools?(c.isStatic&&(c=function(t){setTimeout(t,0)}),n.prototype.invokeLater=function(t,e,r){this._trampolineEnabled?i.call(this,t,e,r):this._schedule(function(){setTimeout(function(){t.call(e,r)},100)})},n.prototype.invoke=function(t,e,r){this._trampolineEnabled?o.call(this,t,e,r):this._schedule(function(){t.call(e,r)})},n.prototype.settlePromises=function(t){this._trampolineEnabled?s.call(this,t):this._schedule(function(){t._settlePromises()})}):(n.prototype.invokeLater=i,n.prototype.invoke=o,n.prototype.settlePromises=s),n.prototype.invokeFirst=function(t,e,r){this._normalQueue.unshift(t,e,r),this._queueTick()},n.prototype._drainQueue=function(t){for(;t.length()>0;){var e=t.shift();if("function"==typeof e){var r=t.shift(),n=t.shift();e.call(r,n)}else e._settlePromises()}},n.prototype._drainQueues=function(){this._drainQueue(this._normalQueue),this._reset(),this._drainQueue(this._lateQueue)},n.prototype._queueTick=function(){this._isTickUsed||(this._isTickUsed=!0,this._schedule(this.drainQueues))},n.prototype._reset=function(){this._isTickUsed=!1},e.exports=new n,e.exports.firstLineError=a},{"./queue.js":28,"./schedule.js":31,"./util.js":38}],3:[function(t,e,r){"use strict";e.exports=function(t,e,r){var n=function(t,e){this._reject(e)},i=function(t,e){e.promiseRejectionQueued=!0,e.bindingPromise._then(n,n,null,this,t)},o=function(t,e){this._isPending()&&this._resolveCallback(e.target)},s=function(t,e){e.promiseRejectionQueued||this._reject(t)};t.prototype.bind=function(n){var a=r(n),u=new t(e);u._propagateFrom(this,1);var c=this._target();if(u._setBoundTo(a),a instanceof t){var l={promiseRejectionQueued:!1,promise:u,target:c,bindingPromise:a};c._then(e,i,u._progress,u,l),a._then(o,s,u._progress,u,l)}else u._resolveCallback(c);return u},t.prototype._setBoundTo=function(t){void 0!==t?(this._bitField=131072|this._bitField,this._boundTo=t):this._bitField=-131073&this._bitField},t.prototype._isBound=function(){return 131072===(131072&this._bitField)},t.bind=function(n,i){var o=r(n),s=new t(e);return s._setBoundTo(o),o instanceof t?o._then(function(){s._resolveCallback(i)},s._reject,s._progress,s,null):s._resolveCallback(i),s}}},{}],4:[function(t,e,r){"use strict";function n(){try{Promise===o&&(Promise=i)}catch(t){}return o}var i;"undefined"!=typeof Promise&&(i=Promise);var o=t("./promise.js")();o.noConflict=n,e.exports=o},{"./promise.js":23}],5:[function(t,e,r){"use strict";var n=Object.create;if(n){var i=n(null),o=n(null);i[" size"]=o[" size"]=0}e.exports=function(e){function r(t,r){var n;if(null!=t&&(n=t[r]),"function"!=typeof n){var i="Object "+a.classString(t)+" has no method '"+a.toString(r)+"'";throw new e.TypeError(i)}return n}function n(t){var e=this.pop(),n=r(t,e);return n.apply(t,this)}function i(t){return t[this]}function o(t){var e=+this;return 0>e&&(e=Math.max(0,e+t.length)),t[e]}var s,a=t("./util.js"),u=a.canEvaluate;a.isIdentifier;e.prototype.call=function(t){for(var e=arguments.length,r=new Array(e-1),i=1;e>i;++i)r[i-1]=arguments[i];return r.push(t),this._then(n,void 0,void 0,r,void 0)},e.prototype.get=function(t){var e,r="number"==typeof t;if(r)e=o;else if(u){var n=s(t);e=null!==n?n:i}else e=i;return this._then(e,void 0,void 0,t,void 0)}}},{"./util.js":38}],6:[function(t,e,r){"use strict";e.exports=function(e){var r=t("./errors.js"),n=t("./async.js"),i=r.CancellationError;e.prototype._cancel=function(t){if(!this.isCancellable())return this;for(var e,r=this;void 0!==(e=r._cancellationParent)&&e.isCancellable();)r=e;this._unsetCancellable(),r._target()._rejectCallback(t,!1,!0)},e.prototype.cancel=function(t){return this.isCancellable()?(void 0===t&&(t=new i),n.invokeLater(this._cancel,this,t),this):this},e.prototype.cancellable=function(){return this._cancellable()?this:(n.enableTrampoline(),this._setCancellable(),this._cancellationParent=void 0,this)},e.prototype.uncancellable=function(){var t=this.then();return t._unsetCancellable(),t},e.prototype.fork=function(t,e,r){var n=this._then(t,e,r,void 0,void 0);return n._setCancellable(),n._cancellationParent=void 0,n}}},{"./async.js":2,"./errors.js":13}],7:[function(t,e,r){"use strict";e.exports=function(){function e(t){this._parent=t;var r=this._length=1+(void 0===t?0:t._length);j(this,e),r>32&&this.uncycle()}function r(t,e){for(var r=0;r<e.length-1;++r)e[r].push("From previous event:"),e[r]=e[r].join("\n");return r<e.length&&(e[r]=e[r].join("\n")),t+"\n"+e.join("\n")}function n(t){for(var e=0;e<t.length;++e)(0===t[e].length||e+1<t.length&&t[e][0]===t[e+1][0])&&(t.splice(e,1),e--)}function i(t){for(var e=t[0],r=1;r<t.length;++r){for(var n=t[r],i=e.length-1,o=e[i],s=-1,a=n.length-1;a>=0;--a)if(n[a]===o){s=a;break}for(var a=s;a>=0;--a){var u=n[a];if(e[i]!==u)break;e.pop(),i--}e=n}}function o(t){for(var e=[],r=0;r<t.length;++r){var n=t[r],i=_.test(n)||"    (No stack trace)"===n,o=i&&y(n);i&&!o&&(v&&" "!==n.charAt(0)&&(n="    "+n),e.push(n))}return e}function s(t){for(var e=t.stack.replace(/\s+$/g,"").split("\n"),r=0;r<e.length;++r){var n=e[r];if("    (No stack trace)"===n||_.test(n))break}return r>0&&(e=e.slice(r)),e}function a(t){var e;if("function"==typeof t)e="[function "+(t.name||"anonymous")+"]";else{e=t.toString();var r=/\[object [a-zA-Z0-9$_]+\]/;if(r.test(e))try{var n=JSON.stringify(t);e=n}catch(i){}0===e.length&&(e="(empty array)")}return"(<"+u(e)+">, no stack trace)"}function u(t){var e=41;return t.length<e?t:t.substr(0,e-3)+"..."}function c(t){var e=t.match(g);return e?{fileName:e[1],line:parseInt(e[2],10)}:void 0}var l,h=t("./async.js"),p=t("./util.js"),f=/[\\\/]bluebird[\\\/]js[\\\/](main|debug|zalgo|instrumented)/,_=null,d=null,v=!1;p.inherits(e,Error),e.prototype.uncycle=function(){var t=this._length;if(!(2>t)){for(var e=[],r={},n=0,i=this;void 0!==i;++n)e.push(i),i=i._parent;t=this._length=n;for(var n=t-1;n>=0;--n){var o=e[n].stack;void 0===r[o]&&(r[o]=n)}for(var n=0;t>n;++n){var s=e[n].stack,a=r[s];if(void 0!==a&&a!==n){a>0&&(e[a-1]._parent=void 0,e[a-1]._length=1),e[n]._parent=void 0,e[n]._length=1;var u=n>0?e[n-1]:this;t-1>a?(u._parent=e[a+1],u._parent.uncycle(),u._length=u._parent._length+1):(u._parent=void 0,u._length=1);for(var c=u._length+1,l=n-2;l>=0;--l)e[l]._length=c,c++;return}}}},e.prototype.parent=function(){return this._parent},e.prototype.hasParent=function(){return void 0!==this._parent},e.prototype.attachExtraTrace=function(t){if(!t.__stackCleaned__){this.uncycle();for(var s=e.parseStackAndMessage(t),a=s.message,u=[s.stack],c=this;void 0!==c;)u.push(o(c.stack.split("\n"))),c=c._parent;i(u),n(u),p.notEnumerableProp(t,"stack",r(a,u)),p.notEnumerableProp(t,"__stackCleaned__",!0)}},e.parseStackAndMessage=function(t){var e=t.stack,r=t.toString();return e="string"==typeof e&&e.length>0?s(t):["    (No stack trace)"],{message:r,stack:o(e)}},e.formatAndLogError=function(t,e){if("undefined"!=typeof console){var r;if("object"==typeof t||"function"==typeof t){var n=t.stack;r=e+d(n,t)}else r=e+String(t);"function"==typeof l?l(r):"function"!=typeof console.log&&"object"!=typeof console.log||console.log(r)}},e.unhandledRejection=function(t){e.formatAndLogError(t,"^--- With additional stack trace: ")},e.isSupported=function(){return"function"==typeof j},e.fireRejectionEvent=function(t,r,n,i){var o=!1;try{"function"==typeof r&&(o=!0,"rejectionHandled"===t?r(i):r(n,i))}catch(s){h.throwLater(s)}var a=!1;try{a=b(t,n,i)}catch(s){a=!0,h.throwLater(s)}var u=!1;if(m)try{u=m(t.toLowerCase(),{reason:n,promise:i})}catch(s){u=!0,h.throwLater(s)}a||o||u||"unhandledRejection"!==t||e.formatAndLogError(n,"Unhandled rejection ")};var y=function(){return!1},g=/[\/<\(]([^:\/]+):(\d+):(?:\d+)\)?\s*$/;e.setBounds=function(t,r){if(e.isSupported()){for(var n,i,o=t.stack.split("\n"),s=r.stack.split("\n"),a=-1,u=-1,l=0;l<o.length;++l){var h=c(o[l]);if(h){n=h.fileName,a=h.line;break}}for(var l=0;l<s.length;++l){var h=c(s[l]);if(h){i=h.fileName,u=h.line;break}}0>a||0>u||!n||!i||n!==i||a>=u||(y=function(t){if(f.test(t))return!0;var e=c(t);return!!(e&&e.fileName===n&&a<=e.line&&e.line<=u)})}};var m,j=function(){var t=/^\s*at\s*/,e=function(t,e){return"string"==typeof t?t:void 0!==e.name&&void 0!==e.message?e.toString():a(e)};if("number"==typeof Error.stackTraceLimit&&"function"==typeof Error.captureStackTrace){Error.stackTraceLimit=Error.stackTraceLimit+6,_=t,d=e;var r=Error.captureStackTrace;return y=function(t){return f.test(t)},function(t,e){Error.stackTraceLimit=Error.stackTraceLimit+6,r(t,e),Error.stackTraceLimit=Error.stackTraceLimit-6}}var n=new Error;if("string"==typeof n.stack&&n.stack.split("\n")[0].indexOf("stackDetection@")>=0)return _=/@/,d=e,v=!0,function(t){t.stack=(new Error).stack};var i;try{throw new Error}catch(o){i="stack"in o}return"stack"in n||!i||"number"!=typeof Error.stackTraceLimit?(d=function(t,e){return"string"==typeof t?t:"object"!=typeof e&&"function"!=typeof e||void 0===e.name||void 0===e.message?a(e):e.toString()},null):(_=t,d=e,function(t){Error.stackTraceLimit=Error.stackTraceLimit+6;try{throw new Error}catch(e){t.stack=e.stack}Error.stackTraceLimit=Error.stackTraceLimit-6})}([]),b=function(){if(p.isNode)return function(t,e,r){return"rejectionHandled"===t?process.emit(t,r):process.emit(t,e,r)};var t=!1,e=!0;try{var r=new self.CustomEvent("test");t=r instanceof CustomEvent}catch(n){}if(!t)try{var i=document.createEvent("CustomEvent");i.initCustomEvent("testingtheevent",!1,!0,{}),self.dispatchEvent(i)}catch(n){e=!1}e&&(m=function(e,r){var n;return t?n=new self.CustomEvent(e,{detail:r,bubbles:!1,cancelable:!0}):self.dispatchEvent&&(n=document.createEvent("CustomEvent"),n.initCustomEvent(e,!1,!0,r)),n?!self.dispatchEvent(n):!1});var o={};return o.unhandledRejection="onunhandledRejection".toLowerCase(),o.rejectionHandled="onrejectionHandled".toLowerCase(),function(t,e,r){var n=o[t],i=self[n];return i?("rejectionHandled"===t?i.call(self,r):i.call(self,e,r),!0):!1}}();return"undefined"!=typeof console&&"undefined"!=typeof console.warn&&(l=function(t){console.warn(t)},p.isNode&&process.stderr.isTTY?l=function(t){process.stderr.write("[31m"+t+"[39m\n")}:p.isNode||"string"!=typeof(new Error).stack||(l=function(t){console.warn("%c"+t,"color: red")})),e}},{"./async.js":2,"./util.js":38}],8:[function(t,e,r){"use strict";e.exports=function(e){function r(t,e,r){this._instances=t,this._callback=e,this._promise=r}function n(t,e){var r={},n=s(t).call(r,e);if(n===a)return n;var i=u(r);return i.length?(a.e=new c("Catch filter must inherit from Error or be a simple predicate function\n\n    See http://goo.gl/o84o68\n"),a):n}var i=t("./util.js"),o=t("./errors.js"),s=i.tryCatch,a=i.errorObj,u=t("./es5.js").keys,c=o.TypeError;return r.prototype.doFilter=function(t){for(var r=this._callback,i=this._promise,o=i._boundValue(),u=0,c=this._instances.length;c>u;++u){var l=this._instances[u],h=l===Error||null!=l&&l.prototype instanceof Error;if(h&&t instanceof l){var p=s(r).call(o,t);return p===a?(e.e=p.e,e):p}if("function"==typeof l&&!h){var f=n(l,t);if(f===a){t=a.e;break}if(f){var p=s(r).call(o,t);return p===a?(e.e=p.e,e):p}}}return e.e=t,e},r}},{"./errors.js":13,"./es5.js":14,"./util.js":38}],9:[function(t,e,r){"use strict";e.exports=function(t,e,r){function n(){this._trace=new e(o())}function i(){return r()?new n:void 0}function o(){var t=s.length-1;return t>=0?s[t]:void 0}var s=[];return n.prototype._pushContext=function(){r()&&void 0!==this._trace&&s.push(this._trace)},n.prototype._popContext=function(){r()&&void 0!==this._trace&&s.pop()},t.prototype._peekContext=o,t.prototype._pushContext=n.prototype._pushContext,t.prototype._popContext=n.prototype._popContext,i}},{}],10:[function(t,e,r){"use strict";e.exports=function(e,r){var n,i,o=e._getDomain,s=t("./async.js"),a=t("./errors.js").Warning,u=t("./util.js"),c=u.canAttachTrace,l=u.isNode&&(!!process.env.BLUEBIRD_DEBUG||"development"===process.env.NODE_ENV);return u.isNode&&0==process.env.BLUEBIRD_DEBUG&&(l=!1),l&&s.disableTrampolineIfNecessary(),e.prototype._ignoreRejections=function(){this._unsetRejectionIsUnhandled(),this._bitField=16777216|this._bitField},e.prototype._ensurePossibleRejectionHandled=function(){0===(16777216&this._bitField)&&(this._setRejectionIsUnhandled(),s.invokeLater(this._notifyUnhandledRejection,this,void 0))},e.prototype._notifyUnhandledRejectionIsHandled=function(){r.fireRejectionEvent("rejectionHandled",n,void 0,this)},e.prototype._notifyUnhandledRejection=function(){if(this._isRejectionUnhandled()){var t=this._getCarriedStackTrace()||this._settledValue;this._setUnhandledRejectionIsNotified(),r.fireRejectionEvent("unhandledRejection",i,t,this)}},e.prototype._setUnhandledRejectionIsNotified=function(){this._bitField=524288|this._bitField},e.prototype._unsetUnhandledRejectionIsNotified=function(){this._bitField=-524289&this._bitField},e.prototype._isUnhandledRejectionNotified=function(){return(524288&this._bitField)>0},e.prototype._setRejectionIsUnhandled=function(){this._bitField=2097152|this._bitField},e.prototype._unsetRejectionIsUnhandled=function(){this._bitField=-2097153&this._bitField,this._isUnhandledRejectionNotified()&&(this._unsetUnhandledRejectionIsNotified(),this._notifyUnhandledRejectionIsHandled());
